...
$filecontents = file_get_contents('outt3.txt');
...
<script type="text/javascript">
    ...
    for (i = 0; i < locations.length; i++) { 
		...
		if(locations[i][2]=="Vehicle crime"||locations[i][2]=="Shoplifting"||locations[i][2]=="Violence and sexual offences"||locations[i][2]=="Other theft")
